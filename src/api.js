...
export const quizzes = {
  ...
  status: (id, status) => api.patch(`/quizzes/${id}/status`, { status }),
...
export const attempts = {
  ...
  questions: (id) => api.get(`/attempts/${id}/questions`),
  answer: (id, data) => api.post(`/attempts/${id}/answers`, data),
  submit: (id) => api.post(`/attempts/${id}/submit`),
  result: (id) => api.get(`/attempts/${id}/result`),
  detailedResult: (id) => api.get(`/attempts/${id}/detailed-result`)
};
